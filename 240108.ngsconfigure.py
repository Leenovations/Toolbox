...
# BATCH['GTFidx'] = f"/media/src/DB/{BATCH['Ref.ver']}/01.GTF/GENCODEV48"
# BATCH['GTF'] = f"/media/src/DB/{BATCH['Ref.ver']}/01.GTF/gencode.v48.{BATCH['Ref.ver']}.gtf"_
BATCH['BWA'] = f"/media/src/DB/{BATCH['Ref.ver']}/00.FASTA/Homo_sapiens_assembly{BATCH['Ref.ver'].split('g')[1]}.BWA2"
BATCH['GTFidx'] = f"/media/src/DB/{BATCH['Ref.ver']}/01.GTF/NCBIp14"
